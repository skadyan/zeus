...
import com.cumulativeminds.zeus.core.spi.AbstractChangeItemHandler;
...
public class ChangeItemStateHandlerImpl extends AbstractChangeItemHandler implements ChangeItemStateHandler {

    private BeanFactory beanFactory;

    @Inject
    public ChangeItemStateHandlerImpl(BeanFactory beanFactory) {
